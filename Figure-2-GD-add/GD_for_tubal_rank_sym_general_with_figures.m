...
G=1/sqrt(n)*randn(n, n, k, numData); 
...
toc
            ...
            testErrorName=strcat('test_error_', testNum,'.mat');
            trainErrorName=strcat('train_error_', testNum,'.mat');
            principalAnglesName=strcat('principal_angle_error_', testNum,'.mat');  
            singularTubesName=strcat('singular_tubes_', testNum,'.mat');  
            principalAngleToGroundTruthName=strcat('principal_angle_to_ground_truth_', testNum,'.mat'); 
            principalAngleTildeName=strcat('principal_angle_tilde_', testNum,'.mat'); 
